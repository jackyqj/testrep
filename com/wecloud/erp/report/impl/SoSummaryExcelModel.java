...
public class SoSummaryExcelModel extends AbstractExcelModel
{

    public SoSummaryExcelModel(Collection list)
    {
        objList = list;
    }
    ...
    public void setHeader(HSSFSheet sheet)
    {
        ...
        excelHeader.createCell(row++).setCellValue("\u9500\u552E\u91D1\u989D");
    }
    ...
    public void setRows(HSSFSheet sheet)
    {
        ...
        {
            SoSummary obj = (SoSummary)iterator.next();
            int row = 0;
